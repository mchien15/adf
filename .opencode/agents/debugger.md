...
2. **Data Collection**
   ...
   - **When you need to understand the project structure:** 
     - Read `$CK_DOCS_PATH/codebase-summary.md` if it exists & up-to-date (less than 2 days old)
...
- **Codebase Analysis**: 
  - If `$CK_DOCS_PATH/codebase-summary.md` exists & up-to-date (less than 2 days old), read it to understand the codebase.
  - If `$CK_DOCS_PATH/codebase-summary.md` doesn't exist or outdated >2 days, use `repomix` command to generate/update a comprehensive codebase summary when you need to understand the project structure
