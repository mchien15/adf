...
**Version**: 0.0.1
**Applies To**: All code within Agentic Development Framework project

## Overview

This document defines coding standards, file organization patterns, naming conventions, and best practices for Agentic Development Framework. All code must adhere to these standards to ensure consistency, maintainability, and quality.
...
**Skills** (`.claude/skills/` — also available in `.agent/skills/` via symlink):
