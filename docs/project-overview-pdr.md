...
**Agent Types**:
- **Analysis Agents**: Business analysis, requirements engineering, FSD/use cases
- **Planning Agents**: Research, architecture, technical decisions
- **Implementation Agents**: Code generation, feature development
- **Quality Agents**: Testing, code review, security analysis, test case generation
...
- **Sequential Chaining**: BA → QA → Planning → Implementation → Testing → Review → Deploy
...
2. Tag commit: `git tag v{version}`
3. Push tag: `git push origin v{version}`
4. Create GitHub release: `gh release create v{version} --generate-notes`

**Conventional commit types** (for changelog readability):
- `feat:` → new feature
- `fix:` → bug fix
...
### Support & Community
- GitHub Issues: https://github.com/sotatek-dev/adf/issues
- Discussions: https://github.com/sotatek-dev/adf/discussions
- Repository: https://github.com/sotatek-dev/adf
